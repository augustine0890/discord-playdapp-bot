...
RUN rm -rf src && rm /app/target/release/deps/discord_playdapp_bot*
COPY src ./src
...
COPY --from=builder /app/target/release/discord-playdapp-bot /app/discord-playdapp-bot
